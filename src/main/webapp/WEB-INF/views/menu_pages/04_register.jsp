						...
						<form action="register.do" method="post">
							<div class="form-group row">
								...
								<div class="col-md-6" style="padding-bottom: 0px">
									...
									<div id="idchecktext"
										style="text-align: center; margin-left: 0px; margin-bottom: 0px;">
									</div>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input type="password" id="user_pw_confirm"
										class="form-control" name="user_pw_confirm"
										oninput="return checkPw()" required>
									<div id="pwchecktext"
										style="text-align: center; margin-left: 0px; margin-bottom: 0px;">
									</div>
								</div>
							...
							<div class="form-group row">
								<label for="motto" class="col-md-4 col-form-label text-md-right">이름</label>
								<div class="col-md-6">
							...
							<div class="form-group row">
								<label for="motto" class="col-md-4 col-form-label text-md-right">나이</label>
								<div class="col-md-6">
							...
							<div class="form-group row">
								<label for="motto" class="col-md-4 col-form-label text-md-right">자기소개</label>
								<div class="col-md-6">
							...
							<div class="col-md-6 offset-md-4">
								<button type="submit" class="btn btn-primary" id="registerbtn"
									onclick="location:href='login.do'">회원등록</button>
							</div>
					</div>
					</form>
				</div>
